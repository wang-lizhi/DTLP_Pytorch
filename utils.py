...
def parse_arg():
    ...
    parser.add_argument('-blocksize', type=int, default=48) # set the blocksize for network
    parser.add_argument('-channel', type=int, default=31, help="havard: 31, cave: 28") #set channel = 28 for CAVE/KAIST datasets
